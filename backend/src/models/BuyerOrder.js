...
const buyerOrderSchema = new mongoose.Schema(
  {
    ...
    mobileMoneyProvider: { type: String, default: null, trim: true, lowercase: true, index: true },
    mobileMoneyProviderCode: { type: String, default: null, trim: true },
    mobileMoneyReference: { type: String, default: null, trim: true, index: true },
    mobileMoneyExternalId: { type: String, default: null, trim: true, index: true },
    mobileMoneyTransactionId: { type: String, default: null, trim: true },
    mobileMoneyStatus: { type: String, default: null, trim: true },
    mobileMoneyPayerMsisdn: { type: String, default: null, trim: true },
    mobileMoneyLastWebhookAt: { type: Date, default: null },
